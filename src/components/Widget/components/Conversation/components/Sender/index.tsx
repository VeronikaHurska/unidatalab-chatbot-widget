  ...
  return (
    <div ref={refContainer} >
     <div className="ready-questions">
      <button onClick={() => handlePredefinedQuestion("What was the original objective of the transformer architecture designers?")} className="question">
        What was the original objective of ...
      </button>
      <button onClick={() => handlePredefinedQuestion("How is the text that you pass to an LLM named?")} className="question">
        How is the text that you pass to ...
      </button>
      <button onClick={() => handlePredefinedQuestion("What is the strategy to get the model to produce better outcomes?")} className="question">
        What is the strategy to get the model ...
      </button>
    </div>
